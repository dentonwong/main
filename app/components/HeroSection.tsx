...
const HeroSection = () => {
  return (
    <section id="home">
      <div className="my-10 flex flex-col items-center justify-center py-16 text-center sm:py-32 md:flex-row md:space-x-4 md:py-48 md:text-left">
        <div className="animate-fadeInExtended md:mt-2 md:w-1/2">
          <Image
